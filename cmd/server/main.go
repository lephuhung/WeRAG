...
// @in header
// @name X-API-Key
// @description API Key authentication: Tenant Key accesses the corresponding workspace; Platform Key requires X-Tenant-ID header when invoking workspace APIs
package main
