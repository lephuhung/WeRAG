  ...
  return (
    <div className="mx-auto w-full max-w-[1200px]">
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="title-md font-semibold text-ink">Extensions & Integrations</h2>
          <p className="caption text-muted">
            Manage Model Context Protocol (MCP) servers, reusable agent skills, and browser bridging.
          </p>
        </div>
              ...
              {typeof tab.count === "number" && (
                <span
                  className={`rounded-full px-1.5 py-0.2 text-[10px] font-semibold ${
                    active ? "bg-white/20 text-white" : "bg-hairline text-muted-soft"
                  }`}
                >
                  {tab.count}
                </span>
      ...
      {(activeTab === "all" || activeTab === "mcp") && (
        <div className="mb-10">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="text-[15px] font-semibold text-ink">Model Context Protocol (MCP)</h3>
              <p className="caption text-muted">
                    ...
                    <div className="mb-2 flex items-start justify-between gap-3">
                      ...
                      <button
                        ...
                        className={`relative h-6 w-11 shrink-0 rounded-full transition-colors ${
                          s.enabled ? "bg-primary" : "bg-hairline-strong"
                        }`}
      ...
      {(activeTab === "all" || activeTab === "skills") && (
        <div className="mb-10">
          <div className="mb-4">
            <h3 className="text-[15px] font-semibold text-ink">Skill Catalog</h3>
            <p className="caption text-muted">
              Reusable tools, plugins, and sandbox scripts installable into agent workspaces.
            </p>
          </div>
