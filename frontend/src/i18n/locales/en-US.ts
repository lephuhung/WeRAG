export default {
  ...
  inviteRegister: {
    ...
    bannerOrg: 'You will also join the organization "{org}".',
  ...
  knowledgeList: {
    ...
    visibilityPublic: 'Public knowledge base: searchable by all signed-in users',
    visibilityOrg: 'Organization knowledge base: org members only',
  ...
  knowledgeEditor: {
    visibility: {
      ...
      tenantTip: 'Visible to workspace members by role.',
      orgTip: 'Visible to org members and workspace admins only.',
      publicTip: 'Searchable by all signed-in users; managed by workspace owners and system admins.',
    },
    activity: {
      title: 'Activity',
  ...
  tenantOrg: {
    title: 'Organizations',
    sectionDescription: 'Organizations are groups inside a workspace that scope organization knowledge bases.',
    ...
    descriptionLabel: 'Description',
    members: 'Members',
    membersTitle: 'Members of {org}',
    memberCount: '{count} members',
    empty: 'No organizations yet.',
    roleLabel: 'Role',
    role: { member: 'Member', manager: 'Manager' },
    addMember: 'Add member',
    addMemberPlaceholder: 'Select a workspace member',
    makeManager: 'Make manager',
    makeMember: 'Make member',
    inviteLink: 'Invite link',
    inviteTitle: 'Invite to {org}',
    inviteRole: 'Workspace role',
    inviteMessage: 'Invitation message',
    generateLink: 'Generate link',
    inviteHint: 'Accounts registered via this link join both the workspace and this organization.',
    linkCopied: 'Link copied',
    loadFailed: 'Failed to load organizations',
    saveFailed: 'Save failed',
    deleteFailed: 'Delete failed',
    deleteConfirm: 'Delete organization "{name}"? Its knowledge bases are kept but lose the org scope.',
  },
  tenantMember: {
    title: 'Members',
