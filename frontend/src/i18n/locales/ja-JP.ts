export default {
  ...
  knowledgeList: {
    ...
    visibilityPublic: '公開ナレッジベース：ログイン済みの全ユーザーが検索可能',
    visibilityOrg: '組織ナレッジベース：組織メンバーのみ',
  ...
  knowledgeEditor: {
    visibility: {
      ...
      org: '組織',
      public: '公開',
      orgPlaceholder: '組織を選択',
      tenantTip: 'ワークスペースメンバーがロールに応じてアクセスできます。',
      orgTip: '組織メンバーとワークスペース管理者のみ閲覧できます。',
      publicTip: 'ログイン済みの全ユーザーが検索可能。管理はワークスペースオーナーとシステム管理者のみ。',
    },
    activity: {
      title: 'アクティビティ',
  ...
  tenantOrg: {
    title: '組織管理',
    sectionDescription: '組織はワークスペース内のグループで、組織ナレッジベースの公開範囲を制限します。',
    create: '組織を作成',
    createTitle: '組織を作成',
    editTitle: '組織を編集',
    nameLabel: '組織名',
    ...
    descriptionLabel: '説明',
    members: 'メンバー',
    membersTitle: '{org} のメンバー',
    memberCount: '{count} 名',
    empty: '組織がまだありません。',
    roleLabel: 'ロール',
    role: { member: 'メンバー', manager: 'マネージャー' },
    addMember: 'メンバーを追加',
    addMemberPlaceholder: 'ワークスペースメンバーを選択',
    makeManager: 'マネージャーにする',
    makeMember: 'メンバーにする',
    inviteLink: '招待リンク',
    inviteTitle: '{org} に招待',
    inviteRole: 'ワークスペースロール',
    inviteMessage: '招待メッセージ',
    generateLink: 'リンクを生成',
    inviteHint: 'このリンクで登録したアカウントはワークスペースとこの組織の両方に参加します。',
    linkCopied: 'リンクをコピーしました',
    loadFailed: '組織の読み込みに失敗しました',
    saveFailed: '保存に失敗しました',
    deleteFailed: '削除に失敗しました',
    deleteConfirm: '組織 "{name}" を削除しますか？組織のナレッジベースは保持されますが範囲指定が失われます。',
  },
  tenantMember: {
    title: 'メンバー管理',
