export default {
  ...
  tenantOrg: {
    title: '조직 관리',
    sectionDescription: '조직은 워크스페이스 내 그룹으로, 조직 지식 베이스의 공개 범위를 제한합니다.',
    create: '조직 만들기',
    createTitle: '조직 만들기',
    editTitle: '조직 편집',
    nameLabel: '조직 이름',
    namePlaceholder: '조직 이름 입력',
    descriptionLabel: '설명',
    members: '멤버',
    membersTitle: '{org} 멤버',
    ...
    empty: '아직 조직이 없습니다.',
    roleLabel: '역할',
    role: { member: '멤버', manager: '매니저' },
    addMember: '멤버 추가',
    addMemberPlaceholder: '워크스페이스 멤버 선택',
    makeManager: '매니저로 지정',
    makeMember: '멤버로 지정',
    inviteLink: '초대 링크',
    inviteTitle: '{org}에 초대',
    inviteRole: '워크스페이스 역할',
    inviteMessage: '초대 메시지',
    generateLink: '링크 생성',
    inviteHint: '이 링크로 가입한 계정은 워크스페이스와 이 조직에 모두 가입됩니다.',
    linkCopied: '링크가 복사되었습니다',
    loadFailed: '조직을 불러오지 못했습니다',
    saveFailed: '저장에 실패했습니다',
    deleteFailed: '삭제에 실패했습니다',
    deleteConfirm: '조직 "{name}"을(를) 삭제하시겠습니까? 조직 지식 베이스는 유지되지만 범위 지정이 해제됩니다.',
  },
  tenantMember: {
    title: '멤버 관리',
  ...
  knowledgeEditor: {
    visibility: {
      ...
      org: '조직',
      public: '공개',
      orgPlaceholder: '조직 선택',
      tenantTip: '워크스페이스 멤버가 역할에 따라 접근할 수 있습니다.',
      orgTip: '조직 멤버와 워크스페이스 관리자만 볼 수 있습니다.',
      publicTip: '로그인한 모든 사용자가 검색할 수 있으며, 워크스페이스 소유자와 시스템 관리자만 관리할 수 있습니다.',
    },
  ...
  knowledgeList: {
    ...
    visibilityPublic: '공개 지식 베이스: 로그인한 모든 사용자가 검색 가능',
    visibilityOrg: '조직 지식 베이스: 조직 멤버만',
