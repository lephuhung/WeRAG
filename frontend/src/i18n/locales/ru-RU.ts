export default {
  ...
  tenantOrg: {
    title: 'Организации',
    sectionDescription: 'Организации — группы внутри пространства, ограничивающие видимость баз знаний.',
    ...
    members: 'Участники',
    membersTitle: 'Участники {org}',
    memberCount: 'Участников: {count}',
    empty: 'Организаций пока нет.',
    roleLabel: 'Роль',
    role: { member: 'Участник', manager: 'Менеджер' },
    addMember: 'Добавить участника',
    addMemberPlaceholder: 'Выберите участника пространства',
    makeManager: 'Назначить менеджером',
    makeMember: 'Назначить участником',
    inviteLink: 'Ссылка-приглашение',
    inviteTitle: 'Пригласить в {org}',
    inviteRole: 'Роль в пространстве',
    inviteMessage: 'Сообщение приглашения',
    generateLink: 'Создать ссылку',
    inviteHint: 'Аккаунты, зарегистрированные по этой ссылке, вступают и в пространство, и в организацию.',
    linkCopied: 'Ссылка скопирована',
    loadFailed: 'Не удалось загрузить организации',
    saveFailed: 'Не удалось сохранить',
    deleteFailed: 'Не удалось удалить',
    deleteConfirm: 'Удалить организацию "{name}"? Её базы знаний сохранятся, но потеряют привязку.',
  },
  tenantMember: {
    title: 'Участники',
  ...
  knowledgeEditor: {
    visibility: {
      ...
      tenantTip: 'Доступ участникам пространства по ролям.',
      orgTip: 'Видна только участникам организации и администраторам пространства.',
      publicTip: 'Поиск доступен всем авторизованным; управление — владельцам пространства и системным администраторам.',
    },
  ...
  knowledgeList: {
    ...
    visibilityPublic: 'Публичная база знаний: поиск для всех авторизованных',
    visibilityOrg: 'База знаний организации: только для участников',
  ...
  inviteRegister: {
    ...
    bannerOrg: 'Вы также вступите в организацию "{org}".',
  ...
  uploadConfirm: {
    ...
    pdfForceScanned: {
      label: 'Определение типа страниц PDF',
      description: 'Каждая страница автоматически классифицируется как текстовая или скан. Включайте принудительный скан только если автоопределение ошибается — все страницы будут отрендерены в изображения и обработаны OCR/VLM.',
      auto: 'Автоопределение (рекомендуется)',
      force: 'Принудительно как скан',
    }
  },
  knowledgeBase: {
    title: 'База знаний',
