export default {
  ...
  resourceOrigin: {
    ...
    spaceTooltipWithTenant: 'Shared via space "{space}" · from {không gian làm việc}',
    shared: 'External',
  ...
  inviteRegister: {
    bannerTitle: 'You have been invited to join "{không gian làm việc}"',
    ...
    subtitle: 'You\'ve been invited to join “{không gian làm việc}”',
    email: 'Email',
  ...
  tenantInvitation: {
    ...
    myInbox: {
      ...
      acceptSuccess: 'Joined "{không gian làm việc}".',
