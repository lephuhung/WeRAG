export default {
  localBrowser: {
    pipOpen: 'Mở cửa sổ nổi',
    pipReturn: 'Quay lại cuộc trò chuyện',
    pipFailed: 'Không thể mở cửa sổ nổi. Vui lòng thử lại.',
    captureScreenshot: 'Chụp ảnh màn hình',
    navigationIncomplete: 'Điều hướng chưa hoàn tất giai đoạn tải. Vui lòng kiểm tra lại trang.',
    noEntries: 'Không có mục nào được trả về.',
    stopping: 'Đang dừng tác vụ…',
    elapsedSeconds: '{seconds} giây',
    searchInstructionsTitle: 'Hướng dẫn tìm kiếm trình duyệt',
    searchInstructionsDescription: 'Đặt công cụ tìm kiếm và URL tìm kiếm ưa thích của bạn.',
    searchInstructionsHint: 'Áp dụng cho yêu cầu tiếp theo của bạn. Để trống để sử dụng mặc định.',
    searchInstructionsReset: 'Khôi phục mặc định',
    searchInstructionsSaved: 'Đã lưu',
    sourceHint: 'Sử dụng trình duyệt cục bộ để tra cứu và tương tác với các trang trong lượt này, cùng với tìm kiếm web, cơ sở tri thức và các công cụ khác.',
    pressKey: 'Nhấn phím',
    hoverPage: 'Di chuột qua phần tử',
    scrollPage: 'Cuộn trang',
    focusElement: 'Lấy tiêu điểm phần tử',
    blurElement: 'Bỏ tiêu điểm',
    selectOption: 'Chọn tùy chọn',
    closeTab: 'Đóng thẻ',
    runScript: 'Chạy script trang',
    readConsole: 'Đọc console',
    readNetwork: 'Kiểm tra yêu cầu mạng',
    resizeWindow: 'Đổi kích thước cửa sổ',
    emulateDevice: 'Giả lập thiết bị',
    actionPending: 'Đang thao tác trình duyệt…',
    actionRecorded: 'Đã ghi nhận thao tác trình duyệt',
    untitledTab: 'Thẻ chưa có tiêu đề',
    contentTruncated: 'Chỉ hiển thị một phần nội dung trang.',
    controlScope: 'Chỉ điều khiển trình duyệt của cuộc trò chuyện này',
    pauseHint: 'Tạm dừng thao tác trình duyệt và giữ lại các trang để tiếp tục sau.',
    stopHint: 'Đóng các thẻ được tạo bởi tác vụ này. Giữ trình duyệt luôn mở.',
    openPage: 'Mở trang',
    switchPage: 'Chuyển trang',
    readPage: 'Đọc trang',
    listTabs: 'Danh sách thẻ',
    clickPage: 'Nhấp vào phần tử',
    fillPage: 'Điền nội dung',
    waitPage: 'Chờ tải trang',
    openTab: 'Mở thẻ tác vụ',
    switchTab: 'Chuyển thẻ tác vụ',
    authorizeTab: 'Yêu cầu quyền thẻ',
    returnTab: 'Trả lại thẻ',
    needHelp: 'Cần bạn hỗ trợ',
    browserAction: 'Thao tác trình duyệt',
    actionFailed: 'Chưa hoàn tất',
    actionCompleted: 'Thao tác đã hoàn thành',
    commandBusy: 'Lệnh trình duyệt trước đó vẫn đang chạy. Vui lòng đợi.',
    invalidArguments: 'Tham số công cụ trình duyệt không hợp lệ hoặc thiếu.',
    commandInterrupted: 'Thao tác trình duyệt bị gián đoạn. Kiểm tra trang trước khi tiếp tục.',
    actionFailedHint: 'Thao tác trình duyệt không kết thúc thành công. Vui lòng thử lại.',
    previewStale: 'Bản xem trước chưa được cập nhật',
    previewIdle: 'Giữ bản xem trước gần nhất',
    previewLive: 'Đang đồng bộ xem trước',
  ...
  artifactLibrary: {
    title: 'Thư viện tệp tạo ra (Artifacts)',
  ...
  uploadConfirm: {
    ...
    title: 'Xác nhận tải lên tài liệu',
  ...
  agent: {
    ...
    editor: {
      ...
      sandboxBackend: 'Hộp cát',
      sandboxBackendDefault: 'Đã tắt',
  ...
  settings: {
    ...
    sandbox: {
      ...
      inventorySessionKind: 'Cuộc trò chuyện',
      ...
      createStandardTemplate: 'Tạo mới',
  ...
  inviteRegister: {
    ...
    bannerOrg: 'Bạn cũng sẽ tham gia tổ chức "{org}".',
  ...
  auth: {
    login: 'Đăng nhập',
    logout: 'Đăng xuất',
    oidcLogin: 'Đăng nhập bằng SSO / OIDC',
  ...
  knowledgeList: {
    ...
    visibilityPublic: 'Knowledge base công khai: mọi người dùng đều tìm kiếm được',
    visibilityOrg: 'Knowledge base tổ chức: chỉ thành viên tổ chức',
  ...
  embedPublish: {
    ...
    allowedOrigins: 'Tên miền cho phép (CORS)',
    embedCode: 'Mã nhúng iframe',
    widgetCode: 'Kịch bản widget nổi',
  ...
  knowledgeEditor: {
    visibility: {
      ...
      org: 'Tổ chức',
      public: 'Công khai',
      orgPlaceholder: 'Chọn tổ chức',
      tenantTip: 'Thành viên không gian truy cập theo vai trò.',
      orgTip: 'Chỉ thành viên tổ chức và quản trị viên không gian xem được.',
      publicTip: 'Mọi người dùng đã đăng nhập đều tìm kiếm được; chỉ Owner và quản trị hệ thống được quản lý.',
    },
    activity: {
      title: 'Activity',
  ...
  general: {
    ...
    description: 'Quản lý tùy chọn ngôn ngữ, giao diện và hệ thống',
    settings: 'Cài đặt',
    close: 'Close Settings'
  },
  theme: {
    theme: 'Giao diện',
    themeDescription: 'Tùy chỉnh màu sắc giao diện hệ thống',
    light: 'Sáng',
    dark: 'Tối',
  ...
  font: {
    ...
    uiFontDescription: 'Chọn phông chữ hiển thị cho toàn bộ hệ thống',
    monoFont: 'Phông chữ mã nguồn',
    monoFontDescription: 'Phông chữ hiển thị khối mã lệnh và văn bản đơn cách',
    ...
    fontSize: 'Cỡ chữ',
    fontSizeDescription: 'Điều chỉnh kích thước hiển thị chữ giao diện',
    size: {
      small: 'Small',
      normal: 'Normal',
      large: 'Large'
  ...
  integrations: {
    ...
    api: {
      ...
      apiKeyCapabilityClearGroup: 'Xóa',
  ...
  tenantOrg: {
    ...
    sectionDescription: 'Tổ chức là nhóm trong không gian, dùng để giới hạn phạm vi knowledge base của tổ chức.',
    create: 'Tạo tổ chức',
    createTitle: 'Tạo tổ chức',
    editTitle: 'Sửa tổ chức',
    nameLabel: 'Tên tổ chức',
    namePlaceholder: 'Nhập tên tổ chức',
    descriptionLabel: 'Mô tả',
    members: 'Thành viên',
    membersTitle: 'Thành viên của {org}',
    memberCount: '{count} thành viên',
    empty: 'Chưa có tổ chức nào.',
    roleLabel: 'Vai trò',
    role: { member: 'Thành viên', manager: 'Quản trị viên' },
    addMember: 'Thêm thành viên',
    addMemberPlaceholder: 'Chọn thành viên không gian',
    makeManager: 'Đặt làm quản trị',
    makeMember: 'Đặt làm thành viên',
    inviteLink: 'Link mời',
    inviteTitle: 'Mời vào {org}',
    inviteRole: 'Vai trò không gian',
    inviteMessage: 'Lời nhắn',
    generateLink: 'Tạo link',
    inviteHint: 'Tài khoản đăng ký qua link này sẽ tham gia cả không gian và tổ chức.',
    linkCopied: 'Đã sao chép link',
    loadFailed: 'Không tải được danh sách tổ chức',
    saveFailed: 'Lưu thất bại',
    deleteFailed: 'Xoá thất bại',
    deleteConfirm: 'Xoá tổ chức "{name}"? Knowledge base của tổ chức được giữ lại nhưng mất phạm vi.',
  },
  tenantMember: {
    title: 'Thành viên không gian làm việc',
  ...
  platformApiKeys: {
    ...
    description: 'Create platform credentials for cross-workspace automation. Use X-Không gian làm việc-ID for workspace APIs.',
    ...
    capabilityHint: 'Workspace capabilities apply to the X-Không gian làm việc-ID target; system capabilities apply to control-plane APIs.',
    lastUsed: 'Last used',
    createdAt: 'Created',
    actions: 'Thao tác',
    never: 'Never',
